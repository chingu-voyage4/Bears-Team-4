...
class CouponDetails extends Component {
  ...
  render() {
    var couponDetailsShowHide = {display : this.state.detailsOpen ? "block" : "none" };
      ...
      <div className="couponDetails">
        ...
        <div className="couponDetails__expand" style={couponDetailsShowHide}>
          <div className="couponDetails__expand__tabs">
              <a onClick={this.changeTab.bind(this, "details")} className={this.state.selectedTab === "details" ? "active" : ""}>Details</a>
              <a onClick={this.changeTab.bind(this, "comments")} className={this.state.selectedTab === "comments" ? "active" : ""}>Comments</a>
          </div>
          <div className="couponDetails__expand__tabsInfo">
              <div className="couponDetails__expand__tabsInfo__details" style={this.showHideTab("details")}>
                <div><span>Ends:</span> Tomorrow</div>
                <div><span>Exclusions:</span> Exclusions Apply.</div>
                <div><span>Details:</span> Get up to 50% off all cold weather styles for women, men, & kids. SHOP NOW</div>
              </div>
